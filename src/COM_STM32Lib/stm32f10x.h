 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */           
  ...
  //#define HSE_VALUE    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */
	#define HSE_VALUE    ((uint32_t)8000000) /*!< Value of the External oscillator in Hz */ //2014-8-7 by:gf 与硬件实际晶振一致
 #else 
...
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0xFFFF) /*!< Time out for HSE start up */  // 2014-12-12 modify for GD32
